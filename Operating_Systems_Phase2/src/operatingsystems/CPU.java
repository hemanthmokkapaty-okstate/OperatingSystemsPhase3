	...
	public static void CPU(int X, int Y) {
		...
		try {
			...
			if (Instruction_Type_T.equals("0")) {
				...
				String second_half = Instruction_Register.substring(8,16);
				...
				/*Code to be added in phase 2 */
				if(first_half.equals("00010100") && second_half.equals("00000000"))
				{
				...
				//halt condition
				if(first_half.equals("00011000") && second_half.equals("00000000"))
				{
				...
				//output + halt
				if(first_half.equals("00010100") && second_half.equals("00011000"))
				{
					IO_Clock = IO_Clock+15;
					System.out.println(Stack[TOS]);
					Output = Stack[TOS];
				...
				if(first_half.equals("00000000")&&second_half.equals("00000000"))
				{
					PC = PC +1;
					CPU(PC,Trace_Flag);
				}
				//zero Add operation
				if(first_half.equals("00000101") && second_half.equals("00000000"))
				{
					PC = PC +1;
